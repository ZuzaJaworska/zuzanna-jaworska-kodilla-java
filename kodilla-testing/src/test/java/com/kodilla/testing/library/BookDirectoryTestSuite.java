...
public class BookDirectoryTestSuite {
    ...
    class testsListBooksWithCondition {
        @Test
    ...
    class testsListBooksInHandsOf {
        ...
        void testListBooksInHandsOfWhenZeroBooks() {
            ...
            when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(zeroBooksList);
        ...
        void testListBooksInHandsOfWhenOneBook() {
            ...
            when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(oneBookList);
        ...
        void testListBooksInHandsOfWhenFiveBooks() {
            ...
            when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(fiveBooksList);
